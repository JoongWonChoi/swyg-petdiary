...
public class Pet { //반려동물 테이블과 매핑
    ...
    /*반려동물 생성 로직*/
    public void registerPet(String petName, String type, String typeDetail, String birthDay, String sex, Member member) {
    ...
    /*반려동물 수정 로직*/
    public void updatePet(String petName, String type, String typeDetail, String birthDay, String sex) {
        this.petName = petName;
        this.type = type;
        this.typeDetail = typeDetail;
        this.birthDay = birthDay;
